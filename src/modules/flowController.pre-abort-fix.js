...
export const FlowController = {
    ...
    // ── Narration abort signal ────────────────────────────────────
    // Set by abortNarration() (called from GlobalExitButton on forced exit).
    // startNarration() races every await against this promise so the async
    // chain exits immediately without touching ghost DOM elements.
    ...
    async startNarration(audioHandle) {
        ...
        // ── Abort signal — resolves the moment abortNarration() is called ──
        // Every await in this chain races against this promise so a forced exit
        // cuts through immediately without touching ghost DOM on a new screen.

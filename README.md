...
JavaScript (Vite)
AI & Intelligence :
Claude (LLM for narrative generation)
OpenClaw (agent orchestration & interaction layer)
Medo (experience & conversational flow system)
Voice & Audio :
ElevenLabs (AI voice synthesis)
WebSpeech API (speech interaction)
WebAudio API (ambient soundscapes & adaptive audio)
Vision / Input :
OCR.Space (text recognition for museum labels)
Experience Design

...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-boqgimo36ayp-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| Query Endpoint | `GET https://app-boqgimo36ayp-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}` |
